...
앞으로는 끝까지 열정을 가지고 하겠습니다.
유니티의 흐름을 알게 되어서 앞으로의 작업에서는 더 잘할 수 있다고 생각하고 열심히 하겠습니다.
> 
노시현
> unity로 작업을 하는게 처음이라 잘 할수 있을까, 팀에게 민폐가 되진 않을까 걱정을 많이 했지만 3주간 팀 작업을 하면서 새로운 걸 많이 알게되고 서로가 서로에게 부족한 부분을 채워줬던 유익한 시간이었습니다.
덕분에 작동 원리나 흐름을 잘 이해 할수 있었고, 어떤 방식으로 문제에 접근하여 해결해야 하는지 알수 있게 되었습니다.
> 
허찬영
